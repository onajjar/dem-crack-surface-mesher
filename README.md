...
[![Docker](https://img.shields.io/badge/Docker-headless%20workflow-2496ED?logo=docker&logoColor=white)](https://github.com/onajjar/dem-crack-surface-mesher/blob/linux/docs/docker.md)
...
|---|---|---|---|
| **Windows** | [`windows`](https://github.com/onajjar/dem-crack-surface-mesher/tree/windows) | Windows desktop/headless workflows and Docker Desktop with Linux containers | [Windows README](https://github.com/onajjar/dem-crack-surface-mesher/blob/windows/README.md) · [Docker guide](https://github.com/onajjar/dem-crack-surface-mesher/blob/windows/docs/docker.md) |
| **Linux** | [`linux`](https://github.com/onajjar/dem-crack-surface-mesher/tree/linux) | Native desktop/headless workflows and Docker Engine | [Linux README](https://github.com/onajjar/dem-crack-surface-mesher/blob/linux/README.md) · [Linux guide](https://github.com/onajjar/dem-crack-surface-mesher/blob/linux/docs/linux.md) · [Docker guide](https://github.com/onajjar/dem-crack-surface-mesher/blob/linux/docs/docker.md) |
...
dependencies. Each command then starts a disposable container, while generated
files remain on the host in `container-output`:

```text
project + Dockerfile -> image -> temporary container -> container-output
```

On Windows, install Docker Desktop and select Linux-container mode. On Linux,
install Docker Engine with the Compose plugin. Then run:

```console
git clone --branch linux --single-branch https://github.com/onajjar/dem-crack-surface-mesher.git converter-docker
cd converter-docker
...
The included constant-plane example requires no host Python, Conda, Cast3M, or
Gmsh. The image is intentionally headless; use a native platform setup for the
Tk desktop workbench. See the illustrated [Docker and containers guide](https://github.com/onajjar/dem-crack-surface-mesher/blob/linux/docs/docker.md)
for concepts, installation links, mount examples, commands, and troubleshooting.
